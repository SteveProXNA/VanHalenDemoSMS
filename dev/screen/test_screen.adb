...
S:Ltest_screen.screen_test_screen_load$ro$1$43({2}DG,STtag_struct_record_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_load$ho$1$43({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:G$screen_test_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.screen_test_screen_update$screen_type$1$44({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$ro$1$45({2}DG,STtag_struct_record_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$input1$1$45({1}SC:U),R,0,0,[l]
F:Ftest_screen$load_record$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Ftest_screen$tag_struct_scroll_object[({0}S:S$scroll_value_offset$0$0({1}SC:U),Z,0,0)]
T:Ftest_screen$tag_struct_hack_object[({0}S:S$hack_object_sound_play$0$0({1}SC:U),Z,0,0)]
T:Ftest_screen$tag_struct_cursor_object[({0}S:S$cursor_index_x$0$0({1}SC:U),Z,0,0)({1}S:S$cursor_index_y$0$0({1}SC:U),Z,0,0)({2}S:S$cursor_value_x$0$0({1}SC:U),Z,0,0)({3}S:S$cursor_value_y$0$0({1}SC:U),Z,0,0)]
T:Ftest_screen$tag_struct_storage_object[({0}S:S$Magic$0$0({4}SL:U),Z,0,0)({4}S:S$save_album_index$0$0({1}SC:U),Z,0,0)({5}S:S$terminal$0$0({1}SC:U),Z,0,0)]
T:Ftest_screen$tag_struct_delay_object[({0}S:S$delay_value$0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0$0({2}SI:U),Z,0,0)]
T:Ftest_screen$tag_struct_reset_object[({0}S:S$reset_value$0$0({2}SI:U),Z,0,0)({2}S:S$reset_timer$0$0({2}SI:U),Z,0,0)]
T:Ftest_screen$tag_struct_record_object[({0}S:S$record_album_index$0$0({1}SC:U),Z,0,0)]
