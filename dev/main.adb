...
T:Fmain$tag_struct_scroll_object[({0}S:S$scroll_value_offset$0$0({1}SC:U),Z,0,0)]
T:Fmain$tag_struct_hack_object[({0}S:S$hack_object_sound_play$0$0({1}SC:U),Z,0,0)]
...
S:Lmain.main$global_pause$1$56({1}:S),E,0,0
