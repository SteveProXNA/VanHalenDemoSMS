...
S:Lfont_manager.engine_font_manager_draw_char$ch$1$20({1}SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_char$x$1$20({1}SC:U),B,1,5
S:Lfont_manager.engine_font_manager_draw_char$y$1$20({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_char$pnt$1$21({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_char$tile$1$21({1}SC:U),R,0,0,[c]
F:G$engine_font_manager_draw_text$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lfont_manager.engine_font_manager_draw_text$text$1$22({2}DG,SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_text$x$1$22({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_text$y$1$22({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_text$pnt$1$23({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_text$idx$1$23({1}SC:U),B,1,-1
S:Lfont_manager.engine_font_manager_draw_text$tile$2$24({1}SC:S),R,0,0,[b]
F:G$engine_font_manager_draw_data$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lfont_manager.engine_font_manager_draw_data$data$1$25({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_data$x$1$25({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_data$y$1$25({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_data$pnt$1$26({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_data$idx$1$26({1}SC:U),B,1,-2
S:Lfont_manager.engine_font_manager_draw_data$tile$1$26({1}SC:S),R,0,0,[c]
S:Lfont_manager.engine_font_manager_draw_data$quotient$1$26({2}SI:U),R,0,0,[e,d]
S:Lfont_manager.engine_font_manager_draw_data$remainder$1$26({1}SC:U),R,0,0,[b]
